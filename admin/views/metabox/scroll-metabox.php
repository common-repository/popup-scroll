	...
	<tbody> 
		...
		<tr class="cmb-type-radio">
			...
			<td> 
				...
				<?php
				$px_option = get_post_meta($post->ID,'_chch_pusf_scroll_px',true);
				$default_px = '0';
				$px = $px_option ? $px_option : $default_px;
				?>
				<label for="_chch_pusf_email">Pixels from top:</label><br />
				<input class="cmb_text_medium" name="_chch_pusf_px" id="_chch_pusf_px" value="<?php echo $px; ?>" type="text">
		...
		<tr class="cmb-type-radio">
			...
			<td> 
				...
				$default_percent = '0';
				$percent = $percent_option ? $percent_option : $default_percent;
				?>
				<label for="_chch_pusf_email">Percents from top:</label><br />
				<input class="cmb_text_medium" name="_chch_pusf_percent" id="_chch_pusf_percent" value="<?php echo $percent; ?>" type="text">
